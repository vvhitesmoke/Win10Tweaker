#########################################
# WinTweaker WTSettingUWPDiagInfo class #
...
class WTSettingUWPDiagInfo : WTTweakBase {
    WTSettingUWPDiagInfo() {
        $this.Name        = "SettingUWPSyncWithOtherDevices"
        $this.Alias       = "UWPSyncWithOtherDevices"
        $this.Description = "Access to diagnostic info from UWP apps."
